  ...
  <div class="box">
      <header>
        <div class="wrapper">
            ...
            <nav>
              <ul id="menu">
              <li><a onmousedown="eger.play()" href="adatok.php">Regisztralt felhasznalok</a></li>
              <li><a onmousedown="eger.play()" href="munkaltato.php">Munkaltatóink</a></li>
              <li><a onmousedown="eger.play()" href="iskola.php">Iskolak</a></li>
              <!--<li><a onmousedown="eger.play()" href="#">Hirdető cégeink</a></li>-->
      ...
      <div class="content-area">
        ...
        <?php
            ...
            if(!$conn){
                ...
                $stid=oci_parse($conn, 'SELECT CEGNEV, NEV, EGYEB_INFO FROM MUNKALTATO');
                if(!$stid){
                    $e=oci_error($conn);
                    trigger_error(htmlentities($e['nemtudom'], ENT_QUOTES), E_USER_ERROR);
                }
                ...
                echo '<th >Cégnév: </th>';
                echo '<th >Cég tulajdonos:</th>';
                echo '<th >Egyéb információ: </th>';
