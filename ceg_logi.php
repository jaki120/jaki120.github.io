...
<body>
  <div class="box">
      ...
      <div id="profil">
          ...
          <form id="Bejelentkezés" action="ceg_logi.php" method="POST">
            <fieldset id="log">
              ...
              <p>Nincs még fiókja?<a href="ceg_regi.php"> Hozzon létre egyet!</a></p>
          ...
          <?php
            ...
            if (isset($_POST["bej"])){
               ...
               session_start();
               $query = "SELECT MUNKALTATOID  FROM MUNKALTATO WHERE EMAIL =
                :email and PW=:pwd"; 
